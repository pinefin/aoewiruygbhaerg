...
do
    ...
    menu = library.new([[<b>mommy<font color="rgb(78, 93, 234)">ware</font></b>]], "nemv2\\")
    local tabs = {
    ...
    do
        ...
        targeting.element("Toggle", "down check")
    ...
    do
        ...
        oof.element("Slider", "size", {default = {min = 1, max = 15, default = 15}})
        oof.element("Slider", "offset", {default = {min = 100, max = 2000, default = 400}})
    ...
    for _,Player in pairs (Players:GetPlayers()) do
        ...
        if not OnScreen then
            ...
            if not OnScreen then
                ...
                Drawing.PointC = Rotate(Point + Vector2.new((-Size*2), (Size*2)), Point, Rotation)
